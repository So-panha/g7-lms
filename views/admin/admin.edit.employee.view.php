<form class="form_add_employee grow" method="POST" action="controllers/admin/admin.update.employee.controller.php">
  ...
  <div class="checks">
    <input type="checkbox" class="check" id="check" name="sendInvite">
  ...
  <!-- place employee -->
  <input type="number" class="amount"value="<?php echo $user['amount']; ?>" id="amount" name="amount" placeholder="Amount">
